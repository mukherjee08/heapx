...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "test_richcompare",
        "sources": [
            "/Users/mukhani/Documents/GitHub/heapx/test_richcompare.pyx"
        ]
    },
    "module_name": "test_richcompare"
}
END: Cython Metadata */
...
#define __PYX_HAVE__test_richcompare
#define __PYX_HAVE_API__test_richcompare
/* Early includes */
#include <string.h>
#include <stdio.h>
#ifdef _OPENMP
...
/* Module declarations from "test_richcompare" */
static CYTHON_INLINE void __pyx_f_16test_richcompare_sift_richcompare_min(PyObject *, Py_ssize_t); /*proto*/
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "test_richcompare"
extern int __pyx_module_is_main_test_richcompare;
int __pyx_module_is_main_test_richcompare = 0;

/* Implementation of "test_richcompare" */
...
static const char __pyx_k_pop_test[] = "pop_test";
static const char __pyx_k_qualname[] = "__qualname__";
static const char __pyx_k_set_name[] = "__set_name__";
static const char __pyx_k_IndexError[] = "IndexError";
static const char __pyx_k_is_coroutine[] = "_is_coroutine";
static const char __pyx_k_test_richcompare[] = "test_richcompare";
static const char __pyx_k_asyncio_coroutines[] = "asyncio.coroutines";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_test_richcompare_pyx[] = "test_richcompare.pyx";
static const char __pyx_k_1A_r_A_j_T_r_A_D_q_4t1_a_r_1_1[] = "\200\001\340\004\030\230\003\2301\230A\330\004\007\200r\210\023\210A\330\010\016\210j\230\001\230\021\340\004\r\210T\220\021\220!\330\004\007\200r\210\023\210A\330\010\014\210D\220\001\330\010\017\210q\340\004\013\2104\210t\2201\330\004\010\210\001\210\025\210a\330\004\030\230\001\230\026\230r\240\022\2401\330\004\013\2101";
static const char __pyx_k_Note_that_Cython_is_deliberately[] = "Note that Cython is deliberately stricter than PEP-484 and rejects subclasses of builtin types. If you need to pass subclasses then set the 'annotation_typing' directive to False.";
static const char __pyx_k_Test_using_PyObject_RichCompareB[] = "Test using PyObject_RichCompareBool directly.";
/* #### Code section: decls ### */
static PyObject *__pyx_pf_16test_richcompare_pop_test(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_heap); /* proto */
...
#define __pyx_n_u_last __pyx_string_tab[10]
...
#define __pyx_n_u_pop_test __pyx_string_tab[16]
...
#define __pyx_n_u_test_richcompare __pyx_string_tab[21]
#define __pyx_kp_u_test_richcompare_pyx __pyx_string_tab[22]
...
static CYTHON_INLINE void __pyx_f_16test_richcompare_sift_richcompare_min(PyObject *__pyx_v_heap, Py_ssize_t __pyx_v_n) {
  Py_ssize_t __pyx_v_pos;
  Py_ssize_t __pyx_v_child;
  Py_ssize_t __pyx_v_right;
  Py_ssize_t __pyx_v_parent;
  CYTHON_UNUSED PyObject **__pyx_v_arr;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("sift_richcompare_min", 0);

  /* "test_richcompare.pyx":20
 *     """Sift using PyObject_RichCompareBool directly."""
 *     cdef:
 ...
 * 
*/
  __pyx_v_arr = ((PyObject **)(((PyObject *)__pyx_v_heap) + 2));

  /* "test_richcompare.pyx":25
 * 
 ...
 * 
*/
  __pyx_t_1 = PyList_GET_ITEM(__pyx_v_heap, 0);
  __pyx_t_2 = ((PyObject *)__pyx_t_1);
  __Pyx_INCREF(__pyx_t_2);
  __pyx_v_item = __pyx_t_2;
  __pyx_t_2 = 0;

  /* "test_richcompare.pyx":26
 *     # Get item at position 0
 *     item = <object>PyList_GET_ITEM(heap, 0)
 *     Py_INCREF(item)             # <<<<<<<<<<<<<<
 * 
 ...
 *                 child = right
*/
      __pyx_t_1 = PyList_GET_ITEM(__pyx_v_heap, __pyx_v_right);

      /* "test_richcompare.pyx":34
 *         if right < n:
 *             if PyObject_RichCompareBool(<object>PyList_GET_ITEM(heap, right),
 *                                         <object>PyList_GET_ITEM(heap, child), Py_LT):             # <<<<<<<<<<<<<<
 *                 child = right
 *         # Move child up
*/
      __pyx_t_4 = PyList_GET_ITEM(__pyx_v_heap, __pyx_v_child);
 ...
 *                 child = right
*/
      __pyx_t_5 = PyObject_RichCompareBool(((PyObject *)__pyx_t_1), ((PyObject *)__pyx_t_4), Py_LT); if (unlikely(__pyx_t_5 == ((int)-1))) __PYX_ERR(0, 33, __pyx_L1_error)
      __pyx_t_3 = (__pyx_t_5 != 0);
      if (__pyx_t_3) {

        /* "test_richcompare.pyx":35
 *             if PyObject_RichCompareBool(<object>PyList_GET_ITEM(heap, right),
 *                                         <object>PyList_GET_ITEM(heap, child), Py_LT):
 *                 child = right             # <<<<<<<<<<<<<<
 *         # Move child up
 ...
 *         pos = child
*/
    __pyx_t_4 = PyList_GET_ITEM(__pyx_v_heap, __pyx_v_pos);
    Py_DECREF(((PyObject *)__pyx_t_4));

    /* "test_richcompare.pyx":40
 *         Py_INCREF(tmp)
 *         Py_DECREF(<object>PyList_GET_ITEM(heap, pos))
 *         PyList_SET_ITEM(heap, pos, tmp)             # <<<<<<<<<<<<<<
 *         pos = child
 *         child = (pos << 1) + 1
*/
    PyList_SET_ITEM(__pyx_v_heap, __pyx_v_pos, __pyx_v_tmp);

    /* "test_richcompare.pyx":41
 *         Py_DECREF(<object>PyList_GET_ITEM(heap, pos))
 *         PyList_SET_ITEM(heap, pos, tmp)
 *         pos = child             # <<<<<<<<<<<<<<
 *         child = (pos << 1) + 1
...
*/
    __pyx_t_4 = PyList_GET_ITEM(__pyx_v_heap, __pyx_v_parent);
    __pyx_t_5 = PyObject_RichCompareBool(__pyx_v_item, ((PyObject *)__pyx_t_4), Py_LT); if (unlikely(__pyx_t_5 == ((int)-1))) __PYX_ERR(0, 47, __pyx_L1_error)
    __pyx_t_3 = (!(__pyx_t_5 != 0));
    if (__pyx_t_3) {

      /* "test_richcompare.pyx":48
 *         parent = (pos - 1) >> 1
 *         if not PyObject_RichCompareBool(item, <object>PyList_GET_ITEM(heap, parent), Py_LT):
 *             break             # <<<<<<<<<<<<<<
 *         tmp = <object>PyList_GET_ITEM(heap, parent)
 ...
 * 
*/
  PyList_SET_ITEM(__pyx_v_heap, __pyx_v_pos, __pyx_v_item);

  /* "test_richcompare.pyx":58
 *     Py_INCREF(item)
 *     PyList_SET_ITEM(heap, pos, item)
 *     Py_DECREF(item)             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  __Pyx_AddTraceback("test_richcompare.sift_richcompare_min", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_16test_richcompare_1pop_test(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
PyDoc_STRVAR(__pyx_doc_16test_richcompare_pop_test, "Test pop using RichCompareBool.");
static PyMethodDef __pyx_mdef_16test_richcompare_1pop_test = {"pop_test", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_16test_richcompare_1pop_test, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_16test_richcompare_pop_test};
static PyObject *__pyx_pw_16test_richcompare_1pop_test(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("pop_test (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "pop_test", 0) < 0) __PYX_ERR(0, 60, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("pop_test", 1, 1, 1, i); __PYX_ERR(0, 60, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("pop_test", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 60, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("test_richcompare.pop_test", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_heap), (&PyList_Type), 1, "heap", 1))) __PYX_ERR(0, 60, __pyx_L1_error)
  __pyx_r = __pyx_pf_16test_richcompare_pop_test(__pyx_self, __pyx_v_heap);
...
static PyObject *__pyx_pf_16test_richcompare_pop_test(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_heap) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("pop_test", 0);

  /* "test_richcompare.pyx":62
 * def pop_test(list heap):
 *     """Test pop using RichCompareBool."""
 *     cdef Py_ssize_t n = len(heap)             # <<<<<<<<<<<<<<
 *     if n == 0:
...
*/
  ...
  __pyx_t_1 = __Pyx_PyList_GET_SIZE(__pyx_v_heap); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 62, __pyx_L1_error)
  __pyx_v_n = __pyx_t_1;

  /* "test_richcompare.pyx":63
 *     """Test pop using RichCompareBool."""
 *     cdef Py_ssize_t n = len(heap)
 *     if n == 0:             # <<<<<<<<<<<<<<
 *         raise IndexError("empty")
...
*/
    ...
    __pyx_t_6 = 1;
    {
      PyObject *__pyx_callargs[2] = {__pyx_t_4, __pyx_mstate_global->__pyx_n_u_empty};
...
*/
    ...
    __pyx_t_3 = __Pyx_PyList_Pop(__pyx_v_heap); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 68, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

    /* "test_richcompare.pyx":69
 *     if n == 1:
 *         heap.pop()
 *         return result             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  __pyx_t_3 = __Pyx_PyList_Pop(__pyx_v_heap); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_v_last = __pyx_t_3;
  __pyx_t_3 = 0;

  /* "test_richcompare.pyx":72
 * 
 *     last = heap.pop()
 *     heap[0] = last             # <<<<<<<<<<<<<<
 *     sift_richcompare_min(heap, n - 1)
...
*/
  ...
  if (unlikely((__Pyx_SetItemInt(__pyx_v_heap, 0, __pyx_v_last, long, 1, __Pyx_PyLong_From_long, 1, 0, 0, 1) < 0))) __PYX_ERR(0, 72, __pyx_L1_error)

  /* "test_richcompare.pyx":73
 *     last = heap.pop()
 *     heap[0] = last
 *     sift_richcompare_min(heap, n - 1)             # <<<<<<<<<<<<<<
 *     return result
*/
  __pyx_f_16test_richcompare_sift_richcompare_min(__pyx_v_heap, (__pyx_v_n - 1)); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 73, __pyx_L1_error)

  /* "test_richcompare.pyx":74
 *     heap[0] = last
 *     sift_richcompare_min(heap, n - 1)
 *     return result             # <<<<<<<<<<<<<<
*/
...
static int __pyx_pymod_exec_test_richcompare(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_test_richcompare},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
namespace {
  ...
  #endif
  {
      ...
      "test_richcompare",
      __pyx_k_Test_using_PyObject_RichCompareB, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
...
__Pyx_PyMODINIT_FUNC PyInit_test_richcompare(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_test_richcompare(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_test_richcompare(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'test_richcompare' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "test_richcompare" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_test_richcompare", 0);
  ...
  if (__pyx_module_is_main_test_richcompare) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "test_richcompare")) {
      if (unlikely((PyDict_SetItemString(modules, "test_richcompare", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 *     cdef Py_ssize_t n = len(heap)
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_16test_richcompare_1pop_test, 0, __pyx_mstate_global->__pyx_n_u_pop_test, NULL, __pyx_mstate_global->__pyx_n_u_test_richcompare, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 60, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_pop_test, __pyx_t_2) < 0) __PYX_ERR(0, 60, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "test_richcompare.pyx":1
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init test_richcompare", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init test_richcompare");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static const __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {__pyx_k_pop_test, sizeof(__pyx_k_pop_test), 0, 1, 1}, /* PyObject cname: __pyx_n_u_pop_test */
  {__pyx_k_qualname, sizeof(__pyx_k_qualname), 0, 1, 1}, /* PyObject cname: __pyx_n_u_qualname */
  {__pyx_k_result, sizeof(__pyx_k_result), 0, 1, 1}, /* PyObject cname: __pyx_n_u_result */
  {__pyx_k_set_name, sizeof(__pyx_k_set_name), 0, 1, 1}, /* PyObject cname: __pyx_n_u_set_name */
  {__pyx_k_test, sizeof(__pyx_k_test), 0, 1, 1}, /* PyObject cname: __pyx_n_u_test */
  {__pyx_k_test_richcompare, sizeof(__pyx_k_test_richcompare), 0, 1, 1}, /* PyObject cname: __pyx_n_u_test_richcompare */
  {__pyx_k_test_richcompare_pyx, sizeof(__pyx_k_test_richcompare_pyx), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_test_richcompare_pyx */
  {0, 0, 0, 0, 0}
};
/* InitStrings.proto */
...
static int __Pyx_InitCachedBuiltins(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  __pyx_builtin_IndexError = __Pyx_GetBuiltinName(__pyx_mstate->__pyx_n_u_IndexError); if (!__pyx_builtin_IndexError) __PYX_ERR(0, 64, __pyx_L1_error)
  return 0;
  __pyx_L1_error:;
  return -1;
}
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    const __Pyx_PyCode_New_function_description descr = {1, 0, 0, 4, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 60, 95};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_heap, __pyx_mstate->__pyx_n_u_n, __pyx_mstate->__pyx_n_u_result, __pyx_mstate->__pyx_n_u_last};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_test_richcompare_pyx, __pyx_mstate->__pyx_n_u_pop_test, __pyx_k_1A_r_A_j_T_r_A_D_q_4t1_a_r_1_1, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
